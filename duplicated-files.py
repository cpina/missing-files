...
def main(directory1, directory2, directory3, directory4):
    ...
    duplicated_files_both_sets = directory_information_1['fileset'].intersection(directory_information_2['fileset'])

    duplicated_files_both_sets = list(duplicated_files_both_sets)
    duplicated_files_both_sets.sort()

    directory_to_missing_files = {}

    for file in duplicated_files_both_sets:
        print("File in both sets: {}".format(file))
    ...
    print("Number of duplicate files: {}".format(len(duplicated_files_both_sets)))
    print("===================================================")

    # for directory in directory_to_missing_files.keys():
    #     print("The files below can no longer be found. On the server they were in the following folder: '{}':".format(directory))
...
if __name__ == "__main__":
    ...
    parser.add_argument("directory2", type=str, help="Directory with the initial file set")
